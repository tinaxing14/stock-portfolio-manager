  ...
  return (
    <div className="bg-white rounded-2xl overflow-hidden"
      ...
      <div className="px-6 py-4" style={{ borderBottom: '1px solid #f1f5f9' }}>
        <h2 className="text-base font-bold text-slate-800">Total Portfolio Allocation</h2>
        ...
        <div className="flex gap-8 items-center mb-8">
          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="flex items-center justify-between pt-3" style={{ borderTop: '1px solid #f1f5f9' }}>
              <span className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Total Net Worth</span>
              <span className="text-2xl font-bold text-slate-900 tabular-nums">{formatCurrency(data.total)}</span>
            </div>
          </div>
        </div>

        {/* Per-account breakdown — always visible */}
          ...
          <div style={{ borderTop: '1px solid #f1f5f9' }}>
            ...
            <div className="space-y-5">
              {data.byAccount.map((acc) => {
                ...
                const ofNetWorth  = data.total > 0 ? (acc.total   / data.total) * 100 : 0;
                return (
